...
sample_config_path = '/mnt/nfs/work1/brun/yixuezhao/video2scenario/config_files/v2s_config_signin.json'
output_config_path = '/mnt/nfs/work1/brun/yixuezhao/video2scenario/config_files/v2s_config_search.json'
video_dir = '/mnt/nfs/scratch1/yixuezhao/input/Search/'
